...
export default function TeamPage() {
  const achievements = [
    ...
    { id: 2, title: "COST & MANUFACTURING", rank: "3", event: "SAE SUPRA 2024" },
    { id: 3, title: "ENDURANCE RACE", rank: "6", event: "SAE SUPRA 2024" },
    { id: 4, title: "ENGINEERING DESIGN", rank: "9", event: "SAE SUPRA 2024" },
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-black to-red-950">
      <div className="max-w-[1400px] mx-auto px-8 pt-16">
        <h1 className="text-center mb-8 lg:mb-12">
          <span className="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-red-800 via-red-600 to-red-400 text-transparent bg-clip-text">
            ABOUT US
          </span>
        </h1>
            ...
            <div className="col-span-6 col-start-7">
              ...
              <div className="flex flex-row gap-4">
                <a 
                  ...
                  className="flex-1"
                >
                  <button className="w-full bg-transparent border-2 border-green-500 text-white px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 hover:bg-green-500/7 hover:border-green-400 hover:shadow-[0_0_10px_5px_rgba(34,197,94,0.5)]">
                    SAE SUPRA
                  </button>
                </a>
